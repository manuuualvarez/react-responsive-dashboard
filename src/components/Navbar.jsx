...
const Navbar = () => {
  ...
  const { activeMenu, setactiveMenu, isClicked, setisClicked, handleClick, screenSize, setscreenSize, currentColor } = useStateContext(true);
        ...
        >
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={() => handleClick('userProfile')}>
            ...
            <p>
              ...
              <span className='text-gray-400 font-bold ml-1 text-14'>Manuel</span>
            </p>
